...
exports.updatePromo3 = exports.getPromo3 = exports.addPromo3 = void 0;
const Promo3_1 = __importDefault(require("../../models/Promo3"));
const cloudinary_1 = require("cloudinary");
const streamifier_1 = __importDefault(require("streamifier"));
const addPromo3 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingItems = yield Promo3_1.default.find({});
        ...
        const result = cloudinary_1.v2.uploader.upload_stream({ folder: 'image' }, (error, cloudinaryResult) => __awaiter(void 0, void 0, void 0, function* () {
            if (error) {
                ...
                const Promo3ProductImage = new Promo3_1.default({
                    name,
                    description,
                    offer,
                    price,
                ...
                const Promo3ProductImageResult = yield Promo3ProductImage.save();
                res.status(201).json({
...
exports.addPromo3 = addPromo3;
const getPromo3 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const dayProducts = yield Promo3_1.default.find().populate('product');
...
exports.getPromo3 = getPromo3;
const updatePromo3 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const dayProducts = yield Promo3_1.default.find();
...
exports.updatePromo3 = updatePromo3;
