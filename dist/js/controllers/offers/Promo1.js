...
exports.updatePromo1 = exports.getPromo1 = exports.addPromo1 = void 0;
const Promo1_1 = __importDefault(require("../../models/Promo1"));
const cloudinary_1 = require("cloudinary");
const streamifier_1 = __importDefault(require("streamifier"));
const addPromo1 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingItems = yield Promo1_1.default.find({});
        ...
        const result = cloudinary_1.v2.uploader.upload_stream({ folder: 'image' }, (error, cloudinaryResult) => __awaiter(void 0, void 0, void 0, function* () {
            if (error) {
                ...
                const Promo1ProductImage = new Promo1_1.default({
                    name,
                    description,
                    offer,
                    price,
...
exports.addPromo1 = addPromo1;
const getPromo1 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const dayProducts = yield Promo1_1.default.find().populate('product');
...
exports.getPromo1 = getPromo1;
const updatePromo1 = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const dayProducts = yield Promo1_1.default.find();
...
exports.updatePromo1 = updatePromo1;
